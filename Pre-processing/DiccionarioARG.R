...
network::get.vertex.attribute(Argentina, "InfoLength")
network::set.vertex.attribute(Argentina, "OECD", c(rep(FALSE, 514), rep(NA, 10)))
network::get.vertex.attribute(Argentina, "OECD")
...
network::set.network.attribute(Argentina, "Size", SizeARG)
network::set.network.attribute(Argentina, "Density", DensityARG)
network::set.network.attribute(Argentina, "Clustering", ClusteringARG)
network::set.network.attribute(Argentina, "Country", "Argentina")
network::set.network.attribute(Argentina, "Level", "All")
network::set.network.attribute(Argentina, "OECD", FALSE)
library(igraph)
...
network::set.network.attribute(Argentina3, "Size", SizeARG3)
network::set.network.attribute(Argentina3, "Density", DensityARG3)
network::set.network.attribute(Argentina3, "Clustering", ClusteringARG3)
network::set.network.attribute(Argentina3, "Country", "Argentina")
network::set.network.attribute(Argentina3, "Level", "PhD")
network::set.edge.value(Argentina, "Frequency", Matriz)
network::set.edge.attribute(Argentina3, "weight", edges_arg3$Weight)
network::get.edge.attribute(Argentina3, "weight")
