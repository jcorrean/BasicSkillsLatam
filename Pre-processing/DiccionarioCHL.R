...
network::set.network.attribute(Chile, "Size", SizeCHL)
network::set.network.attribute(Chile, "Density", DensityCHL)
network::set.network.attribute(Chile, "Clustering", ClusteringCHL)
network::set.network.attribute(Chile, "Country", "Chile")
network::set.network.attribute(Chile, "Level", "All")
network::set.network.attribute(Chile, "OECD", TRUE)
Chile
network::set.vertex.attribute(Chile, "OECD", c(rep(TRUE, 208), rep(NA, 10)))
network::get.vertex.attribute(Chile, "OECD")
library(igraph)
