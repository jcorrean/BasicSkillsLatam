...
network::set.network.attribute(Brazil, "Size", SizeBRA)
network::set.network.attribute(Brazil, "Density", DensityBRA)
network::set.network.attribute(Brazil, "Clustering", ClusteringBRA)
network::set.network.attribute(Brazil, "Country", "Brazil")
network::set.network.attribute(Brazil, "Level", "All")
network::set.network.attribute(Brazil, "OECD", FALSE)
Brazil
...
network::get.vertex.attribute(Brazil, "OECD")
save.image("Results/Brazil.RData")
