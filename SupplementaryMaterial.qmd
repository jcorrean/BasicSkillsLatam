...
ggplot(Skills, aes(x = Eigenvector, y = reorder(Node, Eigenvector), color = Level)) +
  ...
  theme(
    axis.text.x = element_text(angle=0, hjust=0.5, size = 35), # Reduced text size for better fit
    axis.text.y = element_text(size = 35), # Reduced text size for better fit
    axis.title.x = element_text(size = 30, colour = "black"),
    axis.title.y = element_text(size = 30, colour = "black"),
    legend.text = element_text(size = 35),
    legend.title = element_text(size = 35),
    legend.position = "bottom", # Moved legend to bottom for better space utilization
    strip.text = element_text(face="bold", size=rel(1.5), colour = "black"), # Reduced facet text size
    strip.background = element_rect(fill="grey", colour="grey"),
