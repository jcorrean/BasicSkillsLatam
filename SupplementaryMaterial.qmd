...
**Model 1**: In this first model we posit that the top five most central basic skills suffices to account for the connectivity observed for our bipartite network in the region. When each of these skills are modeled as statistical terms, their estimates will be positive, greater than zero, and statistically significant. 
...
**Model 2**: In this second model, we also include the effects for doctoral and master's programs.  Given the weak connectivity reported in the descriptive findings, we expect that the effects of graduate programs should be negative and statistically significant.
